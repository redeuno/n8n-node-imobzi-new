	...
	description: INodeTypeDescription = {
		...
		displayOptions: {
			show: {
				...
				options: [
					...
					{ name: 'Buscar Por Codigo', value: 'getByCode', action: 'Buscar contato por codigo' },
					...
					{ name: 'Verificar Existencia', value: 'checkExists', action: 'Verificar se contato existe' },
				],
				default: 'getAll',
			},
			...
			// ==================== OPERATIONS - PROPERTY ====================
			{
				...
				options: [
					{ name: 'Atualizar', value: 'update', action: 'Atualizar imovel' },
					{ name: 'Buscar Por Codigo', value: 'getByCode', action: 'Buscar imovel por codigo' },
					{ name: 'Criar', value: 'create', action: 'Criar imovel' },
					{ name: 'Deletar', value: 'delete', action: 'Deletar imovel' },
					{ name: 'Estatisticas', value: 'statistics', action: 'Obter estatisticas do imovel' },
					{ name: 'Get Many', value: 'getAll', action: 'Listar imoveis' },
					{ name: 'Obter Por ID', value: 'get', action: 'Obter imovel por ID' },
					{ name: 'Verificar Existencia', value: 'checkPropertyExists', action: 'Verificar se imovel existe' },
				],
				default: 'getAll',
			},
			...
			// ==================== OPERATIONS - LEASE ====================
			{
				...
				options: [
					{ name: 'Atualizar', value: 'update', action: 'Atualizar locacao' },
					{ name: 'Criar', value: 'create', action: 'Criar locacao' },
					{ name: 'Deletar', value: 'delete', action: 'Deletar locacao' },
					{ name: 'Get Many', value: 'getAll', action: 'Listar locacoes' },
					{ name: 'Obter Por ID', value: 'get', action: 'Obter locacao por ID' },
				],
				default: 'getAll',
			},
			...
			// ==================== OPERATIONS - TRANSACTION ====================
			{
				...
				options: [
					{ name: 'Atualizar', value: 'update', action: 'Atualizar transacao' },
					{ name: 'Criar', value: 'create', action: 'Criar transacao' },
					{ name: 'Deletar', value: 'delete', action: 'Deletar transacao' },
					{ name: 'Get Many', value: 'getAll', action: 'Listar transacoes' },
					{ name: 'Obter Por ID', value: 'get', action: 'Obter transacao por ID' },
				],
				default: 'getAll',
			},
		...
		displayOptions: {
			show: {
				...
				options: [
					{ name: 'Criar Nota', value: 'create', action: 'Criar nota no historico' },
					{ name: 'Get Many', value: 'getAll', action: 'Listar historico' },
				],
				default: 'getAll',
			},
